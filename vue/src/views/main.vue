...
<template>
    <div class="main" :class="{'main-hide-text': shrink}">
        <div class="sidebar-menu-con" :style="{width: shrink?'80px':'200px', overflow: shrink ? 'visible' : 'auto'}">
            <shrinkable-menu
                :shrink="shrink"
                ...
                <div slot="top" class="logo-con">
                  <transition name="fade">
                    <img src="../images/logo_01.png" alt="" v-if="shrink">
                  </transition>
                </div>
            </shrinkable-menu>
        </div>
        <div class="main-header-con" :style="{paddingLeft: shrink?'80px':'200px'}">
            <div class="main-header">
                ...
                <div class="header-company-con">湖北楚天汉仪科技有限公司</div>
        ...
        <div class="single-page-con" :style="{left: shrink?'80px':'200px'}">

...
<script lang="ts">
    ...
    @Component
    export default class EditDeviceKind extends AbpBase{
        ...
        visibleChange(value:boolean){
            if(!value){
                ...
                console.log(this.$store.state.deviceKind.editDevice)
                this.device=Util.extend(true,{},this.$store.state.deviceKind.editDevice);
            }
        }
        // deviceRule={
